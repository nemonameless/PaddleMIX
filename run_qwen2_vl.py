...
from paddlemix.models.qwen2_vl.modeling_qwen2_vl import Qwen2VLForConditionalGeneration, Qwen2VLVisionConfig
...
# config = Qwen2VLVisionConfig.from_pretrained("Qwen2-VL-2B-Instruct_pd")
